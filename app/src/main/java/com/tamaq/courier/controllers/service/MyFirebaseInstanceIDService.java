...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    public static void sendPushTokenAndSubscribe(Context context) {
        String token = FirebaseInstanceId.getInstance().getToken();
        Log.d(TAG, "Token: " + token);
        FirebaseMessaging.getInstance().subscribeToTopic("/topics/global");
        sendRegistrationToServer(PrefsHelper.getTmpPushNotificationToken(context));
    }
    // [END refresh_token]
    ...
    public void onTokenRefresh() {
        ...
        //// TODO: 15.03.2017 save token here
    }
}
